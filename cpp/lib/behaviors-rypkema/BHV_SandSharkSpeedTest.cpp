...
/*    NAME: Nick Rypkema                                    */
/*    ORGN: MIT                                             */
/*    FILE: BHV_SandSharkSpeedTest.cpp                      */
/*    DATE:                                                 */
/************************************************************/
...
#include "BHV_SandSharkSpeedTest.h"
#include "ZAIC_PEAK.h"
...
BHV_SandSharkSpeedTest::BHV_SandSharkSpeedTest(IvPDomain domain) :
  IvPBehavior(domain)
{
  // Provide a default behavior name
  IvPBehavior::setParam("name", "BHV_SandSharkSpeedTest");
...
bool BHV_SandSharkSpeedTest::setParam(string param, string val)
{
...
void BHV_SandSharkSpeedTest::onSetParamComplete()
{
}
...
void BHV_SandSharkSpeedTest::onHelmStart()
{
}
...
void BHV_SandSharkSpeedTest::onIdleState()
{
}
...
void BHV_SandSharkSpeedTest::onCompleteState()
{
}
...
void BHV_SandSharkSpeedTest::postConfigStatus()
{
}
...
void BHV_SandSharkSpeedTest::onIdleToRunState()
{
}
...
void BHV_SandSharkSpeedTest::onRunToIdleState()
{
}
...
IvPFunction* BHV_SandSharkSpeedTest::onRunState()
{
  updateInfoIn();
...
bool BHV_SandSharkSpeedTest::updateInfoIn()
{
  bool ok1, ok2;
